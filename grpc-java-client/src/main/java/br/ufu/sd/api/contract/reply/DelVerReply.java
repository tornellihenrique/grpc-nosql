...
private static final long serialVersionUID = 0L;
  ...
  protected FieldAccessorTable
    ...
    return br.ufu.sd.core.grpc.NoSqlServiceProto.internal_static_grpc_DelVerReply_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            DelVerReply.class, Builder.class);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    if (!(obj instanceof DelVerReply)) {
      return super.equals(obj);
    }
    DelVerReply other = (DelVerReply) obj;
  ...
  public static DelVerReply parseFrom(
  ...
  public static DelVerReply parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static DelVerReply parseFrom(
  ...
  public static DelVerReply parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static DelVerReply parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static DelVerReply parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(DelVerReply prototype) {
  ...
  public static final class Builder extends
    ...
    @Override
    public DelVerReply getDefaultInstanceForType() {
      return DelVerReply.getDefaultInstance();
    }

    @Override
    public DelVerReply build() {
      DelVerReply result = buildPartial();
    ...
    @Override
    public DelVerReply buildPartial() {
      DelVerReply result = new DelVerReply(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof DelVerReply) {
        return mergeFrom((DelVerReply)other);
      } else {
    ...
    public Builder mergeFrom(DelVerReply other) {
      if (other == DelVerReply.getDefaultInstance()) return this;
      if (other.exito_ != 0) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      DelVerReply parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (DelVerReply) e.getUnfinishedMessage();
  ...
  private static final DelVerReply DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new DelVerReply();
  }

  public static DelVerReply getDefaultInstance() {
