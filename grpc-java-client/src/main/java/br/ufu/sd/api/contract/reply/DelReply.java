...
private static final long serialVersionUID = 0L;
  ...
  public boolean equals(final Object obj) {
    ...
    if (!(obj instanceof DelReply)) {
      return super.equals(obj);
    }
    DelReply other = (DelReply) obj;
  ...
  public static DelReply parseFrom(
  ...
  public static DelReply parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static DelReply parseFrom(
  ...
  public static DelReply parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static DelReply parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static DelReply parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(DelReply prototype) {
  ...
  public static final class Builder extends
    ...
    @Override
    public DelReply getDefaultInstanceForType() {
      return DelReply.getDefaultInstance();
    }

    @Override
    public DelReply build() {
      DelReply result = buildPartial();
    ...
    @Override
    public DelReply buildPartial() {
      DelReply result = new DelReply(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof DelReply) {
        return mergeFrom((DelReply)other);
      } else {
    ...
    public Builder mergeFrom(DelReply other) {
      if (other == DelReply.getDefaultInstance()) return this;
      if (other.exito_ != 0) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      DelReply parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (DelReply) e.getUnfinishedMessage();
  ...
  private static final DelReply DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new DelReply();
  }

  public static DelReply getDefaultInstance() {
