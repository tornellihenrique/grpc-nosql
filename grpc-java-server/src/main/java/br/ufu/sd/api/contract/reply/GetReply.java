...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return br.ufu.sd.core.grpc.NoSqlServiceProto.internal_static_grpc_GetReply_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return br.ufu.sd.core.grpc.NoSqlServiceProto.internal_static_grpc_GetReply_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            br.ufu.sd.api.contract.reply.GetReply.class, br.ufu.sd.api.contract.reply.GetReply.Builder.class);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof br.ufu.sd.api.contract.reply.GetReply)) {
      return super.equals(obj);
    }
    br.ufu.sd.api.contract.reply.GetReply other = (br.ufu.sd.api.contract.reply.GetReply) obj;
  ...
  public static br.ufu.sd.api.contract.reply.GetReply parseFrom(
  ...
  public static br.ufu.sd.api.contract.reply.GetReply parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static br.ufu.sd.api.contract.reply.GetReply parseFrom(
  ...
  public static br.ufu.sd.api.contract.reply.GetReply parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static br.ufu.sd.api.contract.reply.GetReply parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static br.ufu.sd.api.contract.reply.GetReply parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(br.ufu.sd.api.contract.reply.GetReply prototype) {
  ...
  public static final class Builder extends
    ...
    @java.lang.Override
    public br.ufu.sd.api.contract.reply.GetReply getDefaultInstanceForType() {
      return br.ufu.sd.api.contract.reply.GetReply.getDefaultInstance();
    }

    @java.lang.Override
    public br.ufu.sd.api.contract.reply.GetReply build() {
      br.ufu.sd.api.contract.reply.GetReply result = buildPartial();
    ...
    @java.lang.Override
    public br.ufu.sd.api.contract.reply.GetReply buildPartial() {
      br.ufu.sd.api.contract.reply.GetReply result = new br.ufu.sd.api.contract.reply.GetReply(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof br.ufu.sd.api.contract.reply.GetReply) {
        return mergeFrom((br.ufu.sd.api.contract.reply.GetReply)other);
      } else {
    ...
    public Builder mergeFrom(br.ufu.sd.api.contract.reply.GetReply other) {
      if (other == br.ufu.sd.api.contract.reply.GetReply.getDefaultInstance()) return this;
      if (other.exito_ != 0) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      br.ufu.sd.api.contract.reply.GetReply parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (br.ufu.sd.api.contract.reply.GetReply) e.getUnfinishedMessage();
  ...
  private static final br.ufu.sd.api.contract.reply.GetReply DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new br.ufu.sd.api.contract.reply.GetReply();
  }

  public static br.ufu.sd.api.contract.reply.GetReply getDefaultInstance() {
